...
export class Ztrans {
    constructor(page){
        ...
        // Reservation Form
        this.keberangkatan_field = page.locator('label:text-is("Keberangkatan") + div');
        this.tujuan_field = page.locator('label:text-is("Tujuan") + div');
        this.dropdown_keberangkatan = page.locator('label:text-is("Keberangkatan") + div div#dropdown-outlet');
        this.dropdown_tujuan = page.locator('label:text-is("Tujuan") + div div#dropdown-outlet2');
        ...
        this.jumlah_penumpang = page.locator('label:text-is("Penumpang") + div');
    ...
    async isiKeberangkatan(value) {
        ...
        await this.dropdown_keberangkatan.locator(`span:text-is("${value}")`).click();
    }

    async isiTujuan(value) {
        await this.tujuan_field.click();
        await this.dropdown_tujuan.locator(`span:text-is("${value}")`).click();
    }
    ...
    async validasiTotalHargaTiket(harga_tiket, jml_penumpang, expected_total_tiket, current_page, biaya_lainnya, case_flag) {
        ...
        switch(current_page) {
            ...
            case("payment-page") :
                const actual_total_tiket_payment_1 = this.normalizeRupiah(await this.page.locator('div:has-text("Total Bayar") + div > p:has-text("Rp")').innerText());
