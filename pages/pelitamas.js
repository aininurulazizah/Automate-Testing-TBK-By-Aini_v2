...
export class Pelitamas {
    constructor(page){
        ...
        // Reservation Form
        this.keberangkatan_field = page.locator('label:text-is("Keberangkatan") ~ div.form-pp');
        this.tujuan_field = page.locator('label:text-is("Tujuan") ~ div.form-pp');
        ...
        this.jumlah_penumpang = page.locator('label:text-is("Penumpang") ~ div.form-pp');
