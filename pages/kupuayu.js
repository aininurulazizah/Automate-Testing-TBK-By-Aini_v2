...
export class Kupuayu {
    ...
    getPenumpangTerdaftar(i) { // Untuk mendapatkan data penumpang setelah isi data untuk memilih kursi
        return this.page.locator(`#passenger${i}`);
    }
    ...
    async validasiTotalHargaTiket(harga_tiket, jml_penumpang, expected_total_tiket, current_page, biaya_lainnya, case_flag) {
        ...
        switch(current_page) {
            case("seat-page") :
                ...
                //     const actual_total_tiket_seat_1 = this.normalizeRupiah(await this.page.locator('h5.display-price-seat-selected').innerText());
